...
class PretendoManager(QMainWindow):
    ...
    def _build_patch_tab(self):
        ...
        self.patch_url_input = QLineEdit("http://localhost:8080")
        glay.addWidget(QLabel("Target Server URL:"))
    ...
    def patch_citra(self, mode):
        ...
        if mode == "official_restore":
            ...
            url = self.patch_url_input.text() if mode == "custom" else "http://localhost:8080"
